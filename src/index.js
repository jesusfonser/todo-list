...
console.log("Creamos primer proyecto y mostramos todos los proyectos");
createProject("Primer proyecto", undefined, "Este es mi primer proyecto");
console.log(allProjects);

console.log("Añadimos dos toDos al proyecto añadido");
createToDo("Primera tarea", "Esta es la tarea", format(add(new Date(), {days:1,}), 'Pp'), "Alta", undefined, 0);
createToDo("Segunda tarea", "Esta es la otra tarea", format(add(new Date(), {days:1,}), 'Pp'), "Alta", undefined, 0);

console.log("Comprobamos las tareas del proyecto");
allProjects[0].getToDos();
